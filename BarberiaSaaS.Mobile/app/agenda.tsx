...
export default function AgendaScreen(){
 ...
 return <SafeAreaView style={s.page}>
   <View style={s.top}><Pressable onPress={()=>router.back()}><Text style={s.back}>‹ Dashboard</Text></Pressable><Text style={s.title}>Agenda</Text><View style={{width:86}}/></View>
