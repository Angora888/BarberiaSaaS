    ...
    try {
      ...
      const response = await api.post(
        "/Auth/registrar-negocio",
        {
          ...
          identificacion:
            formulario.identificacion.trim() || null,
          telefono:
            formulario.telefono.trim() || null,
          nombrePropietario:
            formulario.nombrePropietario.trim(),
          apellidosPropietario:
            formulario.apellidosPropietario.trim(),
      ...
      <style>
        {`
          ...
          .trial-info-card {
            ...
            padding: 38px;
            color: #fff;
            background: linear-gradient(145deg, #111827 0%, #283548 100%);
            border: none;
          }
          ...
          .trial-submit {
            ...
            border: 0;
            border-radius: 14px;
            background: linear-gradient(135deg, #c62864 0%, #8f204d 100%);
            font-weight: 800;
          }
          ...
          .trial-password-wrap .trial-input {
            padding-right: 52px;
          }
      ...
      <div className="trial-page">
        <nav className="trial-nav sticky-top">
          <div className="container py-3 d-flex align-items-center justify-content-between gap-3">
            ...
            >
              <span className="trial-brand-icon">
                <FaSpa />
              </span>
        ...
        <main className="trial-shell">
          {!registro ? (
            <>
              <div className="text-center mx-auto mb-5" style={{ maxWidth: 760 }}>
                ...
                <h1 className="display-5 fw-bold mb-3">
                  ¿Te gustaría probar Barbería SaaS?
                </h1>
              ...
              <div className="row g-4 align-items-stretch">
                <div className="col-lg-5">
                  <div className="trial-info-card">
                    <span className="trial-info-pill mb-4">
                      <FaShieldAlt />
                      Tu negocio queda separado de los demás
                    </span>

                    <h2 className="fw-bold mb-3">
                      Todo listo para comenzar a organizar tu negocio.
                    </h2>

                    <p className="text-white-50 mb-4">
                      Al registrarte crearemos automáticamente tu negocio, una sucursal
                      principal y tu usuario propietario.
                    </p>
                    ...
                    {[
                      ...
                      <div className="trial-feature" key={texto}>
                        <FaCheckCircle className="trial-check" />
                        <span>{texto}</span>
                      </div>
                    ))}
                    ...
                    <div className="mt-4 pt-3 border-top border-secondary">
                      <small className="text-white-50">
                        Consejo: después de entrar, empieza por Configuración,
                        Servicios y Profesionales. El manual te guía paso a paso.
                      </small>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-7">
                  <div className="trial-form-card">
                    ...
                    <form onSubmit={registrarNegocio}>
                      <div className="row g-3">
                        ...
                        <div className="col-md-6">
                          ...
                          <input
                            ...
                            value={formulario.apellidosPropietario}
                            onChange={manejarCambio}
                      ...
                      <button
                        type="submit"
                        className="btn btn-primary trial-submit w-100 mt-4"
                        disabled={cargando}
                      >
                        {cargando
                          ? "Creando tu negocio..."
                          : "Crear mi negocio y empezar a probar"}
                      </button>
            ...
            <div className="trial-success-card">
              ...
              <span className="badge text-bg-success rounded-pill px-3 py-2 mb-3">
                Registro completado
              </span>
              ...
              <div className="trial-credential text-start mb-4">
                ...
                <div className="fw-bold mb-3">
                  {registro.negocio || formulario.nombreNegocio}
                </div>
              ...
              <Link
                to="/"
                className="d-inline-flex align-items-center gap-2 mt-4 text-secondary text-decoration-none"
              >
                <FaArrowLeft />
                Volver al inicio
              </Link>
