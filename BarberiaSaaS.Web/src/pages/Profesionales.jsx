...
function Profesionales() {
  ...
  const abrirHorarios =
    async (profesional) => {
      ...
      await Promise.all([
        cargarHorarios(profesional.id),
        cargarAlmuerzos(profesional.id)
      ]);
    };
  ...
  const cargarAlmuerzos = async (profesionalId) => {
    try {
      ...
      setError(
        error.response?.data?.mensaje ||
        "No fue posible cargar las horas de almuerzo."
      );
    }
  };
