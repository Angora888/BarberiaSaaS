        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DuracionSlotMinutos = table.Column<int>(type: "integer", nullable: false),
                    PermitirReservaOnline = table.Column<bool>(type: "boolean", nullable: false),
                    MostrarPrecios = table.Column<bool>(type: "boolean", nullable: false),
                    RequiereDeposito = table.Column<bool>(type: "boolean", nullable: false),
                    PorcentajeDeposito = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConfiguracionesTenant_Tenants_TenantId",
                        column: x => x.TenantId,
