...
{
    /// <inheritdoc />
    public partial class AddProfesionalesServicios : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profesionales_Sucursales_SucursalId",
                        column: x => x.SucursalId,
                        principalTable: "Sucursales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Profesionales_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profesionales_SucursalId",
                table: "Profesionales",
                column: "SucursalId");

            migrationBuilder.CreateIndex(
                name: "IX_Profesionales_TenantId",
                table: "Profesionales",
                column: "TenantId");
